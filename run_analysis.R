...
names(one_data_set) <- gsub("Gyro", "Gyroscope", names(one_data_set))
names(one_data_set) <- gsub("Mag", "Magnitude", names(one_data_set))
names(one_data_set) <- gsub("BodyBody", "Body", names(one_data_set))
...
independent_tds <- aggregate(. ~subject + activityid, one_data_set,mean)
independent_tds <-independent_tds[order(independent_tds$subject,independent_tds$activityid),]
